...
public class AutoBidTest extends BaseTest {
	...
	@Test(priority = -2, testName = "Search Product by 'keywordsearch' and start AutoBid", description = "Search Product by 'keywordsearch' and start AutoBid with Netbanking payment - Functionality test")
	...
	@Test(priority = -1, testName = "Search Product from Main category and start AutoBid", description = "Search Product from Main category and start AutoBid with card payment - Functionality test")
	...
	@Test(priority = 1, testName = "Search Product from Speciality store and start AutoBid", description = "Search Product from Speciality Store and start AutoBid with wallet payment - Functionality test")
...
//		loginPage.launchURL().emailpassLoginGeneral();
	...
	@Test(priority = 2, testName = "Search Product from All Products dropdown and start AutoBid", description = "Search Product from All products dropdown and start AutoBid with COD payment - Functionality test")
